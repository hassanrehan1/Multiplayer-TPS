...
onready var weapon_fire = [load("res://Audio/Rifle_fire.wav"), load("res://Audio/Pistol_fire.wav")]
onready var weapon_reload = [load("res://Audio/Rifle_reload.wav"), load("res://Audio/Pistol_reload.wav")]
